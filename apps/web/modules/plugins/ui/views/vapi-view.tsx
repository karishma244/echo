...
const vapiFeatures:Feature[]=[
    {
        ...
        description:"Voice chat directly in yout app",
    },
    {
        icon: PhoneIcon,
        label:"Phone numbers",
                        ...
                        <FormField
                            ...
                            render={({field}) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder="Your private API key" type="password" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
...
export const VapiView = () => {
    ...
    return(
        <>
        <VapiPlugForm open={connectOpen} setOpen={setConnectOpen} />
        <VapiPlugRemoveForm open={removeOpen} setOpen={setRemoveOpen}/>
        <div className="flex min-h-screen flex-col bg-muted p-8">
            <div className="mx-auto w-full max-w-screen-md">
                <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">Connect Vapi to enable AI voice calls and phone support
