...
import { ClockIcon, GlobeIcon, Link, MailIcon, MonitorIcon } from "lucide-react";
                ...
                items:[
                    {
                        label:"Browser",
                        value:
                        userAgentInfo.browser + (userAgentInfo.browserVersion ? `${userAgentInfo.browserVersion}`
                            :""
                        ),
                    },
                    {
            ...
            <div>
                {contactSession.metadata && (
                  ...
                  {accordionSections.map((section)=>(
                    ...
                    >
                    <AccordionTrigger
                    className="flex w-full flex-1 items-start justify-between gap-4 rounded-none
                    bg-accent px-5 py-4 text-left font-medium text-sm outline-none transition-all
