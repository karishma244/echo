...
import { ArrowRightIcon, ArrowUpIcon,  CheckIcon,  CornerUpLeftIcon,  LinkIcon, ListIcon } from "lucide-react";
              ...
              className={cn(
                ...
                <span>
                 ...
                 <div className="flex w-0 grow items-center gap-1">
                  ...
                  <span
                  className={cn("line-clamp-1 text-muted-foreground text-xs",!isLastMessageFromOperator && "font-bold text-black")}
